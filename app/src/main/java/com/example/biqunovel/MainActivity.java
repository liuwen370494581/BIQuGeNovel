...
import com.example.biqunovel.Adapter.MainAdapter;
import com.example.biqunovel.Base.BaseActivity;
import com.example.biqunovel.Fragment.BookCityFragment;
import com.example.biqunovel.Fragment.BookFragment;
import com.example.biqunovel.Fragment.SearchFragment;
import com.example.biqunovel.Fragment.UserInfoFragment;
import com.example.biqunovel.View.MyViewPager;
...
public class MainActivity extends BaseActivity {
    ...
    protected void initView() {
        mViewPager = getView(R.id.id_viewpager);
        mTabLayout = getView(R.id.id_tab_layout);
    ...
    protected void initData() {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                setSelectedTabStyle(mTabLayout, position);
